...
public class Automatizacion extends JFrame {
	...
	private void inicializar() {	
		...
		setTitle("Sistema de Automatización de Reciclado de Agua Gris ");
		...
		Border panelConfigBorder = BorderFactory.createTitledBorder("Panel de Control");
		panelConfig.setBorder(panelConfigBorder);
		panelConfig.setLayout(new GridLayout(5, 1));
		
		JButton fuentesActivas = new JButton();
		fuentesActivas.setText("<html><h1 style='font-size:15px;color:#1d1f21;'><center>Comenzar proceso</center></h1></html>");
		...
		fuentesInactivas.setText("<html><h1 style='font-size:15px;color:#1d1f21;'><center>Distribuir agua procesada</center></h1></html>");
		...
		disponiblidad.setText("<html><h1 style='font-size:15px;color:#1d1f21;'><center>Consultar Disponibilidad</center></h1></html>");
		...
		parametros.setText("<html><h1 style='font-size:14px;color:#1d1f21;'><center>Configurar parámetros de calidad</center></h1></html>");
		...
		estadisticas.setText("<html><h1 style='font-size:15px;color:#1d1f21;'><center>Emitir informe</center></h1></html>");
		...
		pnTanquegris.add(rioButton);
		 ...
		 String initialText = "<html>\n"+ 
	        		...
	        		"<tr><td ><FONT COLOR=\"#dfc48c\" SIZE=\"4\">Capacidad de los Tanques</FONT></td><td ALIGN=\"center\"><FONT COLOR=\"#dfc48c\" SIZE=\"4\" FACE=\"ARIAL\"> "+ Application.getInstance().getTanques().getAguaGrisMax() +"Lts</FONT></td></tr>"+
		...
		initialText = "<html>\n"+ 
        		"<TABLE BGCOLOR=\"#1d1f21\" BORDER=\"1\" CELLPADDING=\"7\" CELLSPACING=\"0\">"+
        		"<tr BGCOLOR=\"#cd6a51\"><th colspan=\"2\"><FONT COLOR=\"#ffffff\" SIZE=\"4\" FACE=\"ARIAL\">Tanques de Filtrado</FONT></th></tr>"+
        		"<tr><td ><FONT COLOR=\"#dfc48c\" SIZE=\"4\">Capacidad de los Tanques</FONT></td><td ALIGN=\"center\"><FONT COLOR=\"#dfc48c\" SIZE=\"4\" FACE=\"ARIAL\">"+ Application.getInstance().getTanques().getFiltradoMax() +" Lts</FONT></td></tr>"+
		...
		initialText = "<html>\n"+ 
        		"<TABLE BGCOLOR=\"#1d1f21\" BORDER=\"1\" CELLPADDING=\"7\" CELLSPACING=\"0\">"+
        		"<tr BGCOLOR=\"#cd6a51\"><th colspan=\"2\"><FONT COLOR=\"#ffffff\" SIZE=\"4\" FACE=\"ARIAL\">Tanques de Tratamiento</FONT></th></tr>"+
        		"<tr><td ><FONT COLOR=\"#dfc48c\" SIZE=\"4\">Capacidad de los Tanques</FONT></td><td ALIGN=\"center\"><FONT COLOR=\"#dfc48c\" SIZE=\"4\" FACE=\"ARIAL\">"+ Application.getInstance().getTanques().getTratamientoMax() +" Lts</FONT></td></tr>"+
		...
		initialText = "<html>\n"+ 
        		"<TABLE BGCOLOR=\"#1d1f21\" BORDER=\"1\" CELLPADDING=\"7\" CELLSPACING=\"0\">"+
        		"<tr BGCOLOR=\"#cd6a51\"><th colspan=\"2\"><FONT COLOR=\"#ffffff\" SIZE=\"4\" FACE=\"ARIAL\">Tanques de Clorificacion</FONT></th></tr>"+
        		"<tr><td ><FONT COLOR=\"#dfc48c\" SIZE=\"4\">Capacidad de los Tanques</FONT></td><td ALIGN=\"center\"><FONT COLOR=\"#dfc48c\" SIZE=\"4\" FACE=\"ARIAL\">"+ Application.getInstance().getTanques().getClorificacionMax() +" Lts</FONT></td></tr>"+
    	...
    	riegoButton.setIcon(createImageIcon("proceso.png"));
		...
		pnTanqueTratado.add(riegoButton);
		 initialText = "<html>\n"+ 
	        		...
	        		"<tr><td ><FONT COLOR=\"#dfc48c\" SIZE=\"4\">Capacidad de los Tanques</FONT></td><td ALIGN=\"center\"><FONT COLOR=\"#dfc48c\" SIZE=\"4\" FACE=\"ARIAL\">"+ Application.getInstance().getTanques().getTratadaMax() +" Lts</FONT></td></tr>"+
	...
	private void crearConfiguracion() {
		...
		panelRed.add(new JLabel(""));
		panelRed.add(new JLabel("Revolución Agitado: "));
		panelRed.add(revolucionAgitado);
		configuracion.add(panelRed);
		
		// Tratamiento biol�gico
		JPanel panelCotas = new JPanel();
		Border panelCotasBorder = BorderFactory.createTitledBorder("Tratamiento biológico");
